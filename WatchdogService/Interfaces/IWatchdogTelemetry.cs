...
namespace Microsoft.ServiceFabric.WatchdogService.Interfaces
{
    ...
    /// </summary>
    public interface IWatchdogTelemetry
    {
        /// <summary>
        ...
        /// <param name="cancellationToken">CancellationToken instance.</param>
        Task ReportMetricAsync(string name, long value, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">CancellationToken instance.</param>
        Task ReportMetricAsync(string name, long value, IDictionary<string, string> properties, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">CancellationToken instance.</param>
        Task ReportMetricAsync(string service, Guid partition, string name, long value, CancellationToken cancellationToken);
        ...
        /// <param name="value">Value if the metric.</param>
        /// <param name="cancellationToken">CancellationToken instance.</param>
        Task ReportMetricAsync(string role, long id, string name, long value, CancellationToken cancellationToken);
