...
namespace TestStatelessService
{
    ...
    [EventSource(Name = "MyCompany-TestStatelessApp-TestStatelessService")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceTraceEventId, Level = EventLevel.Verbose, Message = "Trace '{0}' {1}")]
        public void Trace(string name, string args = "")
        {
            this.WriteEvent(ServiceTraceEventId, name, args);
        }

        private const int ServiceErrorEventId = 8;

        [Event(ServiceErrorEventId, Level = EventLevel.Error, Message = "Error '{0}' {1}")]
        public void Error(string name, string args = "")
        {
            this.WriteEvent(ServiceErrorEventId, name, args);
        }
